...
public class HoloCircularProgressBar extends View {
    ...
    public HoloCircularProgressBar(final Context context,
        ...
        final TypedArray attributes = context.obtainStyledAttributes(attrs,
                R.styleable.HoloCircularProgressBar,
                defStyle, 0);
        ...
        setProgress(attributes
                .getFloat(
                        R.styleable.HoloCircularProgressBar_progress,
                        0.0f));
        setMarkerProgress(attributes
                .getFloat(
                        R.styleable.HoloCircularProgressBar_marker_progress,
                        0.0f));
        setWheelSize(attributes
                .getInt(
                        R.styleable.HoloCircularProgressBar_stroke_width,
                        10));
        mGravity = attributes
                .getInt(R.styleable.HoloCircularProgressBar_gravity,
                        Gravity.CENTER);
